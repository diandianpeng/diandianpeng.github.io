...
step. Hosted on GitHub Pages (served as-is; the `.nojekyll` file disables Jekyll
processing).
...
publications/index.html Publications (peer-reviewed + conference abstracts)
...
Push to `master`; GitHub Pages publishes the repository root automatically.
